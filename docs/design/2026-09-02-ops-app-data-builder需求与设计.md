...
> **opscli app 边界更新**：本文的数据层设计仍可作为历史参考，但其中 `app create/init` 拉模板、固定建站顺序和 `app push` 自动部署描述已于 2026-09-05 失效，相关命令语义以 `docs/design/2026-09-05-opscli-app三命令源码交付职责定稿.md` 为准。
