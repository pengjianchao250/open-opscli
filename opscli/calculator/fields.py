...
FIELD_SPECS: tuple[FieldSpec, ...] = (
    ...
    FieldSpec("product_price", "商品售价", "成本费用", "站点币种", "0", "无需填写，默认 0"),
    FieldSpec("gross_profit_percent", "目标毛利率", "成本费用", "%", "0", "无需填写，默认 0"),
    FieldSpec("purchase_cost_with_tax", "含税采购价", "成本费用", "CNY", "0", "无需填写，默认 0"),
    FieldSpec("tax_rate_percent", "税率", "成本费用", "%", "0", "无需填写，默认 0"),
    FieldSpec("purchase_cost", "非税采购价", "成本费用", "CNY", "0", "无需填写，默认 0"),
    FieldSpec("fee_percent", "平台佣金比", "成本费用", "%", "0", "无需填写，默认 0"),
    FieldSpec("advertising_percent", "站内广告", "成本费用", "%", "0", "无需填写，默认 0"),
    FieldSpec("marketing_percent", "站外营销", "成本费用", "%", "0", "无需填写，默认 0"),
    FieldSpec("refund_percent", "退款", "成本费用", "%", "0", "无需填写，默认 0"),
    FieldSpec("fixed_cost_percent", "固定成本", "成本费用", "%", "0", "无需填写，默认 0"),
    FieldSpec("tariff_rate", "关税率", "成本费用", "%", "0", "无需填写，默认 0"),
