...
Description: 广告预算分配优化器（CLI 模式）
Author: opscli Team
Date: 2026-04-29

Usage:
    echo '{"campaigns": [...], "total_budget": 10000}' | python ads_budget_allocator.py
    python ads_budget_allocator.py --input /tmp/budget_input.json --pretty
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="广告预算分配优化器（CLI 模式）")
