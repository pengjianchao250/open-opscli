...
DEFAULT_RUFUS_QUESTIONS = (
    ...
    "这个产品ASIN {{asin}}五点卖点描述里，最重要的一条是什么？有没有买家很想知道但没写进去的事？",
    "看完这个产品ASIN {{asin}}这些图，还有什么是我想知道但看不出来的？要是再加一张图，加什么最有用？",
    "这个产品ASIN {{asin}}下面那个长的图文介绍，跟上面五点说的有区别吗？看完能让我更放心买吗？还少介绍了什么？",
    "这个产品ASIN {{asin}}评价里大家最常夸和最常抱怨的是什么？这些在介绍里提前说清楚了吗？",
    "这个产品ASIN {{asin}}如果让你给这个产品页面只提一个最着急改的地方，会是什么？",
)
