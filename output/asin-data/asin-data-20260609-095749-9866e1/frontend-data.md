...
- 运行ID：asin-data-20260609-095749-9866e1
- 开始时间：2026-06-09T09:57:49
- 结束时间：2026-06-09T09:57:57
- 输出目录：output\asin-data\asin-data-20260609-095749-9866e1
- ASIN数量：1
- 失败ASIN数量：1
...
| --- | --- | --- | --- | --- | --- | --- |
| B0BY8Y5766 | US | bed frame | 有错误 | 失败 | 失败 | 失败 |
...
[
  ...
  {
    "来源": "seller_sprite.keyword_miner",
    "状态": "失败",
    "原始状态": "failed",
    "原因": null
  },
...
```json
{
  ...
  "行数": null,
  "结果数据": [],
  "错误信息": "SELLER_SPRITE_CONFIG_ERROR: 获取卖家精灵集成账号失败：用户不存在。请检查 OPS 授权：MCP 模式需携带有效 X-MCP-API-Key，CLI 模式执行 opscli auth login。"
}
```
...
```json
{
  ...
  "报告路径": null,
  "数据": [],
  "错误信息": "RUFUS_HEADLESS_CAPTURE_ERROR: 缺少 Playwright，请安装 `opscli[amazon]`"
}
```
