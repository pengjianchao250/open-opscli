...
- 运行ID：asin-data-B0BY8Y5766-20260608-metadata-filter-verify
- 开始时间：2026-06-08T21:12:16
- 结束时间：2026-06-08T21:12:24
- 输出目录：output\asin-data\asin-data-B0BY8Y5766-20260608-metadata-filter-verify
- ASIN数量：1
- 失败ASIN数量：1
...
```json
{
  ...
  "行数": 0,
  "明细": [],
  "原因": "Usage: opscli query simple [OPTIONS]\nTry 'opscli query simple --help' for help.\n┌─ Error ─────────────────────────────────────────────────────────────────────┐\n│ No such option: --dataset                                                   │\n└─────────────────────────────────────────────────────────────────────────────┘"
}
```
